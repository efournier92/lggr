class Week
  ...
  def self.days
    ...
    { 
      ...
      "Friday"    => [task.career_daily, task.git, task.vitamins_take, task.teeth, task.excercise, task.aquarium_jar_and_tank_water_change, task.bank_all, task.lg_audio, task.takeout, task.music],
